...
PYBIND11_MODULE(ikfast_aubo_i3H, m)
{
    m.doc() = R"pbdoc(
        aubo_i3H
        -----------------------
        .. currentmodule:: aubo_i3H
        .. autosummary::
           :toctree: _generate
           get_ik
           get_fk
    ...
    py::arg("free_jt_vals"),
    R"pbdoc(
        get inverse kinematic solutions for aubo_i3H
    )pbdoc");
    ...
    py::arg("joint_list"),
    R"pbdoc(
        get forward kinematic solutions for the aubo_i3H robot
    )pbdoc");
